...
export default function HomePage() {
  ...
  return <PageShell>
    ...
    <section className="national-hub"><div className="hub-heading"><span className="page-eyebrow">One national RTI home</span><h2>The law, the people and the path—together.</h2><p>FOIA made public information legible. India deserves the same clarity, built around the RTI Act and our Central, State and local system.</p></div><div className="hub-grid"><Link href="/resources"><span>01</span><b>Official RTI library</b><p>Acts, Rules, guides, circulars, reports and learning resources.</p><i>Open library →</i></Link><Link href="/authorities"><span>02</span><b>Find the record holder</b><p>Choose the public authority, then reach the correct CPIO path.</p><i>Find authority →</i></Link><Link href="/commissions"><span>03</span><b>Information Commissions</b><p>Central and State oversight, appeals and complaint routes.</p><i>View directory →</i></Link><Link href="/glossary"><span>04</span><b>Understand every term</b><p>Plain language for CPIO, transfer, BPL, exemptions and appeals.</p><i>Use glossary →</i></Link></div></section>
