...
export const faqs = [
  ...
  ['How do I upload a document requested by the authority?', 'Open View Status with the registration number, applicant email, security code and OTP. When the case asks for a supporting document, upload one PDF up to the permitted size.'],
